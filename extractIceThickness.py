...
cdo genbil,r360x180 sit_OImon_NorESM1-M_rcp85_r1i1p1_200601-210012.nc sit_OImon_NorESM1-M_rcp85_r1i1p1_200601-210012_wgts.nc
cdo remap,r360x180,sit_OImon_NorESM1-M_rcp85_r1i1p1_200601-210012_wgts.nc sit_OImon_NorESM1-M_rcp85_r1i1p1_200601-210012.nc sit_OImon_NorESM1-M_rcp85_r1i1p1_200601-210012_rectangular.nc
...
def openCMIP5file(selectedMonth,useSmoothing,CMIP5Hist,CMIP5Proj,myvar,yearsOfSmoothing,yearsToExtract,modelName,scenario,outfilenameResults):
    ...
    print ts
    plotTimeseries(ts,"icethickness")
...
def main():
    ...
    if var=="SeaIceThickness": myvarname="sit"
    ...
    for selectedMonth in selectedMonths:
        for scenario in scenarios:
            ...
            print "-----------------------"
            if var=="SeaIceThickness":
                
                if scenario=="RCP85":
                    modelsRCP = ["sit_OImon_NorESM1-M_rcp85_r1i1p1_200601-210012_rectangular.nc"]
        
                modelsHIST  = ["sit_OImon_NorESM1-M_historical_r1i1p1_185001-200512_rectangular.nc"]
